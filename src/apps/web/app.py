...
# Add config and src directories to path
...
from config import (
    TEMP_UPLOADS_DIR, DEFAULT_MODEL, 
    FLASK_HOST, FLASK_PORT, HF_HOME
)
from shared.dictionary import as_prompt
from shared.history import save as save_history
...
# Store uploads inside the web app folder within the project.
