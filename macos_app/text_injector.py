...
class AppMonitor:
    ...
    def _poll(self):
        """Poll active app every 0.5 seconds."""
        while self._running:
            app = get_active_app()
...
if __name__ == "__main__":
    ...
    test_text = "Phase 3 text injection working correctly."
    input("\nOpen a text editor and click into a text field, then press Enter...")

    success = inject(test_text)
    print(f"Injection: {'✓ success' if success else '✗ failed'}")
