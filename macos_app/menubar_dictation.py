...
os.dup2(devnull, 2)
try:
    from web_mvp.app import format_transcript, get_default_model_name, get_installed_models, get_model_by_name
    from llm_cleanup import clean, warmup  # LLM layer ENABLED - hybrid approach with rule-based formatting
